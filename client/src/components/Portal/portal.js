...
import {TimelineMax, Sine, Elastic, TweenMax } from 'gsap/all';
...
class DoorUI extends React.Component {
    ...
    componentDidUpdate = e => {
     ...
     var tl = new TimelineMax({onComplete:this.setBtnEnabled, onCompleteParams:[true]}).timeScale(5);
     ...
     .to('.bar', 0.4, {
      ...
      stroke:(this.state.open) ? '#F70048' : '#41E969',
       ease:Sine.easeOut
     },0)
     .to( '.ring', 0.4, {
      stroke:(this.state.open) ? '#F70048' : '#41E969'
    ...
    render() {
     return (
      <svg viewBox="200 150 400 300" preserveAspectRatio="xMidYMid meet">
       ...
       <g className="icon">
        <use xlinkHref="#ring" stroke="#F70048" fill="none" className="ring"/>
